...
const char* plataforma_8_5 = "imagenes/plataforma_transparente_8.5_buena.png";
...
const char* sube = "sonidos/subir.wav";
const char* baja = "sonidos/bajar.wav";
const char* salta = "sonidos/salto.wav";